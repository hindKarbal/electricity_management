...
<body>
  ...
  <img src="images/seo.png" class="search-image" alt="Search Image">
     ...
     <a href="AddClient.php" class="btn btn-add mb-3">Add New</a> 
  </div>
      ...
      <tbody>
        <?php foreach ($clients as $row): ?>
          <tr>
            ...
            <td><?= $row["prenom"] ?></td>
            <td><?= $row["email"] ?></td>
            <td><?= $row["prefix"]." ".$row["Tel"] ?></td>
            <td><?= $row["date"] ?></td>
            <td><?= $row["CIN"] ?></td>
            <td><?= $row["gender"] ?></td>
            <td>
            <a href="edit.php?id=<?= $row["id"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3 btn-edit"></i></a>
              <a href="delete.php?id=<?= $row["id"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5 btn-delete"></i></a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
